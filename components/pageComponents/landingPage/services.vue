<template>
	<div id="OurServices">
		...
		<div class="bg">
			<div class="log-bg">
				<img class="icon" src="https://resource.localpanda.com/static/content/wave-center-right.svg" />
			</div>
...
<style lang="scss" scoped>
	...
	#OurServices{
		...
		.bg{
			...
			height: 576px;
			background:url("https://resource.localpanda.com/static/headerPhotos/LP_background.jpg") no-repeat;
			position: relative;
