	...
	<div id="header">
		<div class="heder-cont clearfix">
			...
			<ul class="init" v-if="(logIn==0||logIn==null)&&!isAnonymity">
				<li class="selectCurrency">
					...
					<div class="currencyBox" v-if="showCurrency">
						<div class="currencyItem" :class="{color:item.code==currency}"  v-for="(item,index) in exchange" @click.stop="setCurrency(item,index)">	
							...
							<span v-if="item.code==currency" class="iconfont true">&#xe61e;</span>
						</div>
				...
				<li class="customize" @click="showContact">Customize My Trip<em class="hot">HOT</em></li>
			...
			<ul class="login" v-if="logIn==1">
				...
				<li class="customize" @click="showContact" style="margin-right: 33px;">Customize My Trip<em class="hot">HOT</em></li>
...
#header{
	.currencySvg{
		width: 24px; height: 24px; display: inline-block; vertical-align: middle;
			svg{
			height: 24px; width: 24px; display: inline-block; fill: currentcolor; vertical-align: top;
		}
	}
	.selectCurrencyBtn{
		cursor: pointer;
		i{ display: inline-block; width: 24px; height: 24px; float: left; margin-top:22px;margin-right: 10px;
