				...
				if(that.name == '' || regExp.isNub(that.name) || regExp.isCode(that.name)) {
					...
					if(window.localStorage.getItem("userid")) {
						var obj = {
							...
							participants: that.peopleNub?that.peopleNub:that.peopleNuber,
		...
		<div v-bind:class="{'boxshow animated zoomIn' : contactActive , 'boxshow animated zoomOut' : !contactActive}">
			...
			<div class="con">
				...
				<div class="fillDate clearfix">
					...
					<div class="nuber" v-else>
						<b>Number of People</b>
						<div class="peopleN">
							<div class="peopleshow" :class="{noBottom:isshowchoose}" @click.stop="showchoose">
								<i class="iconfont icon-people">&#xe63d;</i>
								<span v-if="peopleNuber==0">Select People</span>
								<span v-if="peopleNuber==1">1 person</span>
								<span v-if="peopleNuber>1">{{peopleNuber}} people</span>
								<i class="iconfont icon-down" v-if="!isshowchoose">&#xe60f;</i>
								<i class="iconfont icon-down" v-else>&#xe63f;</i>
							</div>
							<div class="choosePeople" v-if="isshowchoose==true" @click.stop="peopleNubfocus">
								<div class="border">
									<b>People</b>
									<div class="operation">
										<em class="iconfont" @click.stop="del(1)">&#xe64d;</em>
										<input v-model="peopleNuber" />
										<em class="iconfont" @click.stop="add(1)">&#xe64b;</em>
									</div>
								</div>
							</div>
						</div>
