	...
	<div id="ActivitiesType">
		<div class="activitiesTypeInfo">
			<div class="linkseting">
				...
				<a v-if="ActivitiesInfo.guideLocation=='Shanghai'" :href="'https://www.localpanda.com/guide/list/'+ActivitiesInfo.guideLocation">Shanghai Guides</a>
				<a v-else :href="'https://www.localpanda.com/guide/list/'+ActivitiesInfo.guideLocation">Beijing Guides</a>
				<em class="iconfont">&#xe64a;</em>
				<a :href="'https://www.localpanda.com/guide/detail/'+ActivitiesInfo.guideId">{{ActivitiesInfo.guideName}}</a>
				<em class="iconfont">&#xe64a;</em>
				<span>Activity</span>
			</div>
			...
			<div class="hostActivities">
				...
				<ul>
					<li v-for="item in activities">
						<a :href="'https://www.localpanda.com/activity/detail/'+item.id" target="_blank">
							<div class="listCont">
	...
	export default {
		...
		methods: {
			...
			contactCallBack(val){
				...
				getscoll(){
					window.location.href='https://www.localpanda.com/guide/detail/'+this.ActivitiesInfo.guideId
				},
