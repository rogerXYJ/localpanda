				...
				<div class="payfordetail">
					...
					<div class="pic">
						<div class="adult clearfix">
							...
							<div class="adultPic">{{opctions.symbol}} {{returnFloat(opctions.amount + (opctions.childDiscount?returnFloat(opctions.childDiscount*opctions.childrenNum):0) + (opctions.couponDiscount?opctions.couponDiscount:0))}}</div>
						</div>
