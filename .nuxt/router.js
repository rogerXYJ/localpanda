...
const _03fba4f8 = () => import('..\\pages\\travel\\_location\\article\\_articleId.vue' /* webpackChunkName: "pages_travel__location_article__articleId" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/travel/:location?/article/:articleId?",
			component: _03fba4f8,
			name: "travel-location-article-articleId"
		},
		{
			path: "/",
			component: _d18eb428,
