...
export default {
    ...
    mounted: function() {
		...
		if(!this.code){
			...
			location.href = 'http://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6d8182a46738b4c1&redirect_uri=http://www.localpanda.cn/wx/getcode&response_type=code&scope=snsapi_base&state=200#wechat_redirect';
		}else{
