<template>
	<div class="payNow">
		...
		<div class="oderdetial">
				...
				<p>Pay with:</p>
				<div class="payfor">
					<img style="width: 200px;" src="https://resource.localpanda.com/static/icon/stripe.png" />
				</div>
  ...
  methods: {
    getToken() {
      ...
      that.stripeHandler = StripeCheckout.configure({
        key: payCode,
        image: "https://resource.localpanda.com/static/icon/logo.png", // 显示在支付对话框的图片，可自己指定
        alipay: true, // 启用支付宝支付
